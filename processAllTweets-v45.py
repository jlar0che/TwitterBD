...
for follower in tweepy.Cursor(api.followers, screen_name="ENTER TWITTER SCREEN NAME HERE").items():
	...
	retrievedStatuses = api.user_timeline(id = follower.id, count = 3)
